        ...
        {!rating && (
          <div className="flex justify-center gap-4">
            <Button
              ...
              variant="outline"
              size="lg"
              className="flex items-center gap-2 hover:bg-green-100 dark:hover:bg-green-900/20 hover:border-green-300 dark:hover:border-green-700"
            >
              <ThumbsUp className="h-5 w-5" />
              Yes, helpful!
            </Button>
            <Button
              ...
              variant="outline"
              size="lg"
              className="flex items-center gap-2 hover:bg-red-100 dark:hover:bg-red-900/20 hover:border-red-300 dark:hover:border-red-700"
            >
              <ThumbsDown className="h-5 w-5" />
              Could be better
            </Button>
          ...
          <div className="space-y-3 mt-4">
            ...
            <div className="space-y-2">
              <textarea
                ...
                onChange={(e) => setComment(e.target.value)}
                placeholder="Optional: Tell us how we can improve..."
                className="w-full p-3 border border-input rounded-md bg-background text-sm resize-none h-20 focus:outline-none focus:ring-2 focus:ring-ring"
              />
              <div className="flex gap-2 justify-end">
                <Button
                  onClick={() => handleCommentSubmit()}
